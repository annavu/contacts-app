...
the task is to implement app where you can store, add, edit and remove contacts
...
[guide here](https://docs.sencha.com/extjs/6.6.0/guides/getting_started/getting_started.html)

then generate app based on this instruction: 

[click](https://docs.sencha.com/cmd/6.6.0/guides/extjs/cmd_app.html)
